import { Sword, Shield, Brain, Database, ShieldCheck, Wrench } from "lucide-react";
import { skills } from "../../lib/data";

const iconMap: Record<string, React.ReactNode> = {
  "Frontend":        <Sword size={14} className="text-green-400" />,
  "Backend":         <Shield size={14} className="text-green-400" />,
  "AI & Search":     <Brain size={14} className="text-green-400" />,
  "Database":        <Database size={14} className="text-green-400" />,
  "Auth & Security": <ShieldCheck size={14} className="text-green-400" />,
  "Tools":           <Wrench size={14} className="text-green-400" />,
};
